...
const blogPosts = [
  {
    id: 'intelligence-artificielle-formation-2025',
    title: 'L\'Intelligence Artificielle dans la formation professionnelle en 2025',
    excerpt: 'Découvrez comment l\'IA révolutionne la formation professionnelle et quelles opportunités cela représente pour les apprenants et les formateurs.',
    ...
    readTime: '10 min',
    featured: true,
    tags: ['IA', 'formation', 'technologie', 'apprentissage']
  },
  {
    id: 'competences-numeriques-2025',
    title: 'Les 10 compétences numériques les plus demandées en 2025',
    excerpt: 'Découvrez les compétences technologiques qui seront essentielles sur le marché du travail en 2025 et comment vous y former.',
    ...
    readTime: '12 min',
    featured: true,
    tags: ['compétences', 'numérique', '2025', 'technologie']
  },
  {
    id: 'formation-cybersecurite-2025',
    title: 'Formation continue en cybersécurité : un impératif en 2025',
    excerpt: 'Avec l\'augmentation des cybermenaces, la formation continue en cybersécurité est devenue essentielle pour les professionnels du numérique.',
