        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <div className="space-y-2 text-gray-700">
              <p><strong>Raison sociale :</strong> Kassiopée Formation — Centre de formation</p>
              ...
              <p><strong>Qualiopi :</strong> OUI</p>
              <p><strong>Siège social :</strong> 35 rue Armand Brette, 93380 Pierrefitte-sur-Seine</p>
          ...
          <section>
            ...
            <div className="text-gray-700">
              <p><strong>Nom :</strong> El-Fka Brahim</p>
          ...
          <section>
            ...
            <div className="text-gray-700 space-y-2">
              ...
              35 rue Armand Brette, 93380 Pierrefitte-sur-Seine</p>
            </div>
          </section>
